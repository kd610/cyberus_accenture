...
for l_c_d in list_class_dir:
    ...
    for i_p in os.listdir(class_dir_path):
        ...
        blur_dir_path = os.path.join(args.export_path, l_c_d, "blur_{l_c_d}_{image_number}.png".format(l_c_d=l_c_d, image_number=image_number))
        print("export: ", blur_dir_path)
        cv2.imwrite(blur_dir_path, blur)
        image_number += 1
